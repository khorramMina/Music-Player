...
const middlePlayButton = document.querySelector(".middle-play-button");
...
function handlePlayPauseUI(audio) {
  const span = document.createElement("span");
  span.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
  <path fill="#a8a4a4" d="m11.596 8.697l-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"/></svg>
          `;
  span.style.display = "inline";
  span.onclick = function () {
    if (span.style.display === "inline") {
  ...
  middlePlayButton.innerHTML = "";
  middlePlayButton.appendChild(span);
}
